...
sysctl -w net.ipv6.conf.lo.forwarding=1 > /dev/null
...
sysctl -w net.ipv6.conf.eth1.forwarding=1 > /dev/null
...
sysctl -w net.ipv6.conf.eth2.forwarding=1 > /dev/null
...
sysctl -w net.ipv6.conf.eth3.forwarding=1 > /dev/null
